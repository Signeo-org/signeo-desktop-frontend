        ...
        >
          ...
          <div className="flex items-center gap-4 mb-10 animate-fade-in-up [animation-delay:100ms] opacity-0 fill-mode-forwards">
            <button
              ...
              `}
            >
              <ArrowLeft className={`w-5 h-5 transition-all duration-300 group-hover:text-[#FDB813] group-hover:-translate-x-1 ${darkMode ? "text-slate-300" : "text-[#5a6c7d]"}`} />
            </button>
          ...
          <div className="space-y-8 animate-fade-in-up [animation-delay:200ms] opacity-0 fill-mode-forwards">
            ...
            >
              ...
              <div
                className={`p-4 mt-2 rounded-lg text-center ${darkMode ? "bg-slate-800/50" : "bg-white/50"}`}
              >
